...
API_TYPE_DICT = {}
API_TYPE_DICT[CHAT] = ['https://api.openai.com/v1/chat/completions']
API_TYPE_DICT[COMPLETION] = ['https://api.openai.com/v1/completions']
API_TYPE_DICT[EMBEDDING] = ['https://api.openai.com/v1/embeddings']
...
async def process_api_requests_from_file(
    ...
    api_type = get_api_type(request_url)
            ...
            if next_request is None:
                if queue_of_requests_to_retry.empty() is False:
                    ...
                    try:
                        ...
                        token_consumption = num_tokens_consumed_from_request(request_json, api_type, token_encoding_name)
...
def get_api_type(request_url, api_dict=API_TYPE_DICT):
...
def num_tokens_consumed_from_request(
    ...
    # more logic needed to support other API calls (e.g., edits, inserts, DALL-E)
        ...
        max_tokens = request_json.get(MAX_TOKENS, MAX_TOKENS_DEFAULT)
